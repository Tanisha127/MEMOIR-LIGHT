...
import {
  ...
  Settings, Wind, BarChart2, LogOut, ChevronLeft, Menu,
} from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <aside
      className={`
        relative flex flex-col bg-white border-r border-stone-lighter/60 h-screen transition-all duration-300
    ...
    >
      ...
      {/* Logo */}
      <div className={`flex items-center gap-3 p-5 border-b border-stone-lighter/60 ${collapsed ? "justify-center px-3" : ""}`}>
        ...
        {!collapsed && (
          <div>
            <div className="font-display font-bold text-stone-warm text-sm leading-tight">Memoir</div>
            ...
            <Link
              ...
              className={`
                ...
                ${active
                  ...
                  : "text-stone-warm hover:bg-cream-100 hover:text-terracotta"
                }
      ...
      {/* User */}
      <div className={`p-3 border-t border-stone-lighter/60 ${collapsed ? "flex justify-center" : ""}`}>
        {!collapsed && (
          <div className="mb-2 px-2">
            <div className="font-ui text-xs text-stone-light">Signed in as</div>
            <div className="font-ui text-sm font-medium text-stone-warm truncate">
        ...
        <button
          ...
          className={`flex items-center gap-2 w-full rounded-2xl px-3 py-2 text-stone-light hover:text-terracotta hover:bg-terracotta/8 transition-all font-ui text-sm ${collapsed ? "justify-center" : ""}`}
        >
          <LogOut size={16} />
